 ...
 */
public class ProgressDrawable extends Drawable implements Drawable.Callback {
    ...
    public ProgressDrawable(int[] colors) {
    ...
    public static class Builder {
        ...
        private void initDefaults(Context context) {
            //Default values
            mColors = context.getResources().getIntArray(R.array.progress_colors);
            return;
        }
        ...
        public Drawable build() {
            return new ProgressDrawable(mColors);
        }
    }
}